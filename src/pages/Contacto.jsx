  ...
  return (
    ...
    <section className='contacto-section'>
        <div className='contacto-div-principal'>
            ...
            La empresa tiene como preferencia la comunicación vía whatsapp, por favor los clientes deberán comunicar sus consultas en el horario laboral de 9 a 18. Fuera de ese horario debera esperar al dia siguiente para obtener su respuesta.
            </p>
